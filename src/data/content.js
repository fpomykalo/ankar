...
export const lifecycle = [
  {
    ...
    tiles: [
      { n: '1.1', title: 'Portfolio Mapping', rect: [474, 60, 184, 235] },
      { n: '1.2', title: 'Landscape Monitoring', rect: [668, 60, 218, 235] },
      { n: '1.3', title: 'Technology Scouting', rect: [474, 305, 412, 135] },
    ],
  },
  {
    label: 'Lifecycle — 2',
    ...
    tiles: [
      { n: '2.1', title: 'Concept Generation', rect: [474, 60, 225, 203] },
      { n: '2.2', title: 'Reformulation', rect: [708, 60, 178, 170] },
      { n: '2.3', title: 'Experiment design', rect: [474, 273, 225, 167] },
      { n: '2.4', title: 'Knowledge Capture', rect: [708, 240, 178, 200] },
    ],
  },
  {
    label: 'Lifecycle — 3',
    ...
    tiles: [
      { n: '3.1', title: 'Patent Drafting', rect: [474, 60, 178, 200] },
      { n: '3.2', title: 'Prosecution', rect: [661, 60, 225, 167] },
      { n: '3.3', title: 'Invalidity', rect: [474, 270, 178, 170] },
      { n: '3.4', title: 'Portfolio Pruning', rect: [661, 237, 225, 203] },
    ],
  },
];
