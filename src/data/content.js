...
export const lifecycle = [
  {
    ...
    tiles: [
      { n: '1.1', title: 'Portfolio Mapping', icon: 'Vector-10', rect: [474, 60, 184, 187] },
      { n: '1.2', title: 'Landscape Monitoring', icon: 'Vector', rect: [668, 60, 218, 187] },
      { n: '1.3', title: 'Technology Scouting', icon: 'Vector-6', rect: [474, 257, 215, 183] },
      { n: '1.4', title: 'Whitespace analysis', icon: 'Vector-18', rect: [699, 257, 187, 183] },
    ],
  },
  {
    label: 'Lifecycle — 2',
    ...
    tiles: [
      { n: '2.1', title: 'Concept Generation', icon: 'Vector-9', rect: [474, 60, 167, 120] },
      { n: '2.2', title: 'Reformulation', icon: 'Vector-8', rect: [651, 60, 235, 120] },
      { n: '2.3', title: 'Result synthesis', icon: 'Vector-1', rect: [474, 190, 113, 120] },
      { n: '2.4', title: 'Knowledge Capture', icon: 'Vector-7', rect: [597, 190, 166, 120] },
      { n: '2.5', title: 'Design acceleration', icon: 'Vector-16', rect: [773, 190, 113, 120] },
      { n: '2.6', title: 'Stage Gate Preparation', icon: 'Vector-14', rect: [474, 320, 235, 120] },
      { n: '2.7', title: 'Experiment design', icon: 'Vector-2', rect: [719, 320, 167, 120] },
    ],
  },
  {
    label: 'Lifecycle — 3',
    ...
    bodyWidth: 362,
    listTitle: 'Workflows:',
    list: ['Prosecution', 'Patent Drafting', 'Invalidity', 'Infringement Detection', 'Invention Disclosure', 'Continuation', 'Portfolio Pruning', 'Freedom to Operate'],
    tiles: [
      { n: '3.1', title: 'Prosecution', icon: 'Vector-4', rect: [474, 60, 113, 120] },
      { n: '3.2', title: 'Patent Drafting', icon: 'Vector-3', rect: [597, 60, 166, 120] },
      { n: '3.3', title: 'Invalidity', icon: 'Vector-5', rect: [773, 60, 113, 120] },
      { n: '3.4', title: 'Infringement Detection', icon: 'Vector-13', rect: [474, 190, 235, 120] },
      { n: '3.5', title: 'Invention Disclosure', icon: 'Vector-12', rect: [719, 190, 167, 120] },
      { n: '3.6', title: 'Continuation', icon: 'Vector-15', rect: [474, 320, 113, 120] },
      { n: '3.7', title: 'Portfolio Pruning', icon: 'Vector-17', rect: [597, 320, 166, 120] },
      { n: '3.8', title: 'Freedom to Operate', icon: 'Vector-11', rect: [773, 320, 113, 120] },
    ],
  },
];
