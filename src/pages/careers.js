...
const team = [
  ...
  { name: 'Henry<br>Martin', label: 'Quote — 2', role: 'R&amp;D GTM Lead;<br>Ex-Fuel Ventures', image: `${BASE}/assets/images/people/henry-martin.jpg`, quote: 'Having seen and met hundreds of brilliant founders and teams during my time in the world of venture capital, I knew the Ankar team were building something truly generational. The clarity of the mission, the density of talent, and the sheer scale of the problem—reinventing how innovation itself gets done—made joining the easiest decision of my career.' },
  { name: 'William<br>Sweetenham', label: 'Quote — 3', role: 'Machine learning Engineer;<br>Ex-Founder', image: `${BASE}/assets/images/pages/story-first-30-days.jpg`, quote: 'At Ankar AI, I get to work on exciting challenges that push me to grow as both a machine learning engineer and a problem-solver. The team is incredibly supportive, everyone’s open to sharing knowledge and helping each other improve. It’s great to see our ideas take shape into real products that make a meaningful impact for R&amp;D and IP teams around the world.' },
];
